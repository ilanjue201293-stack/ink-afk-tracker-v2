...
export default function Dashboard() {
  ...
  return (
    <main className={`shell theme-${tone}`}>
      ...
      {selectedSession && <SessionModal key={`${selectedSession.id}-${selectedSession.active ? "active" : selectedSession.updatedAt}`} session={selectedSession} admin={admin} onClose={() => setSelectedSessionId(null)} onSave={saveSession} onDelete={deleteSelectedSession} />}
